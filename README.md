...
**Acknowledgement**: Thanks to [CJHtea](https://github.com/CJHtea) for catching and updating the "get_positions_of_gap.awk" file to handle genomes assembled to a "no gaps" level.
